...
; I SPAT ON GOD
; ====================================================================================================
; I Spat on God is a port of Super Mario World to the SEGA Mega Drive using
; the Sonic the Hedgehog engine
; ----------------------------------------------------------------------------------------------------

		include "CPU Macros.asm"
		cpu 68000
...
Title_Local:	dc.b 'SUPER MARIOWORLD                                ' ; Domestic name
Title_Int:	dc.b 'SUPER MARIOWORLD                                ' ; International name
Serial:		dc.b 'GM B19ED489-00'   ; Serial/version number
Checksum:	dc.w 0
		dc.b 'J               ' ; I/O support
...
SetupValues:	dc.w $8000		; XREF: PortA_Ok
		...
		obj 0
		xor	a	; clear a to 0
		ld	bc,1fd9h ; prepare to loop this many times
...
Obj41_BounceUp:				; XREF: Obj41_Up
		...
		bset	#1,$22(a1)
		bclr	#3,$22(a1)
		move.b	#2,$1C(a1)	; use "bouncing" animation
		move.b	#2,$24(a1)
		bclr	#3,$22(a0)
		clr.b	$25(a0)
		move.w	#$CC,d0
...
TouchResponse:				; XREF: Obj01
		...
		subq.b	#3,d5
		sub.w	d5,d3
		cmpi.b	#8,$1C(a0)	; is Sonic ducking?
...
Touch_Enemy:				; XREF: Touch_ChkValue
		...
		cmpi.b	#3,$1C(a0)	; is Sonic rolling?
...
loc_71C88:
		move.l	a4,4(a5)
		btst	#4,($FFFFD022).w	; TEMP REPLACE WITH YOSHI FLAG LATER ******
		beq.s	locret_71CAA
		btst	#2,(a5)
		bne.s	locret_71CAA
		moveq	#0,d0
